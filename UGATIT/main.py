...
def parse_args():
    ...
    parser.add_argument('--epoch', type=int, default=100, help='The number of epochs to run')#100
    parser.add_argument('--iteration', type=int, default=1000, help='The number of training iterations')#10000
    parser.add_argument('--batch_size', type=int, default=1, help='The size of batch size')
    parser.add_argument('--print_freq', type=int, default=1000, help='The number of image_print_freq')
    parser.add_argument('--save_freq', type=int, default=5000, help='The number of ckpt_save_freq')#1000
    ...
    parser.add_argument('--ch', type=int, default=32, help='base channel number per layer')#64
